use crate::components::components::Distance;
...
pub mod systems {
    use crate::components::components::{Damage, Health, Position, Range, Score, Speed};
    use crate::systems::{direction, manhattan_distance};
            ...
            &mut world.query::<With<Damage, (&Position, &Damage, &Range, &mut Score)>>()
        {
            let closest = world
                ...
                .min_by_key(|(_, target_position)| {
                    manhattan_distance(tower_position, target_position)
                })
